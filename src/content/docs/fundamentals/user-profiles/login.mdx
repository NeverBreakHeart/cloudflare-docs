...
If your admin has enbaled [enabled SSO](/cloudflare-one/applications/configure-apps/dash-sso-apps/), enter your email address.
...
* **Different Cloudflare account email as Apple ID**: This option creates a new Cloudflare account. If you want to log in to an existing account, [change your email address](/fundamentals/account/change-password-or-email/) to match the one used for your Apple ID.
