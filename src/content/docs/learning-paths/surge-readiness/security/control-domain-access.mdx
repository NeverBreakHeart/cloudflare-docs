...
Access Rules specify an action based on the origin of your user across a single domain or all of the domains in your account. 

Access Rules can be applied based on:
