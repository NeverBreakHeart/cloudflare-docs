...
- macOS: You must explicitly allow both the core networking daemon and GUI component as shown in the following instructions.
  ...
  Due to changes in macOS Sequoia, you must update your macOS firewall settings to allow the WARP client to manage your firewall.

  Make sure the [Block all incoming connections](https://support.apple.com/guide/mac-help/change-firewall-settings-on-mac-mh11783/mac) option is disabled in your macOS firewall settings.
