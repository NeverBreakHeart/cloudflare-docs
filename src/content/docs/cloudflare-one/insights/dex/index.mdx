...
With DEX, you can monitor the state of your [WARP client](/cloudflare-one/connections/connect-devices/warp/) deployment and resolve issues impacting end-user productivity.
...
4. [Monitor](/cloudflare-one/insights/dex/monitoring/) device and network health across your fleet using real-time and historial metrics.
